...
class RcsvOcorrenciaAdmin extends AbstractAdmin {
    //put your code here
     ...
     */
     ...
     //put your code here
    protected $baseRouteName = 'rcsv_ocorrencia-all';
    protected $baseRoutePattern = 'rcsv-ocorrencias';
	protected $objReg;
    ...
    protected function configureListFields(ListMapper $listMapper) {
        $listMapper
               ->add('situacaoRcsv', null,
                  array('template' => 'SonataAdminBundle:CRUD:custom_list_situacao_rcsv.html.twig'))
			    ->add('numeroRcsv', null,
			  ...
			  // ->add('tipoNotificador','text',array('template' => 'SonataAdminBundle:CRUD:custom_list_notificador.html.twig'))
				...
				->add('aerodromo', 'text', array('template' => 'SonataAdminBundle:CRUD:custom_list_aerodromo.html.twig'))
               // ->add('ocorrenciaTipo.situacaoObservada', 'text')
    ...
    protected function configureDatagridFilters(DatagridMapper $datagridMapper) {
        $datagridMapper->add('situacaoRcsv', 'doctrine_orm_choice', array('label' => 'Situação RCSV',
                    'field_options' => array(
                        'required' => false,
                        'choices' => array("ENTRADA" => "CAIXA DE ENTRADA", "AGUARDANDO RESPOSTA" => "AGUARDANDO RESPOSTA" , "ENCERRADO" => "ARQUIVADOS", "LIXEIRA" => "LIXEIRA", "DENÚNCIA" => "DENUNCIA" )
                    ),
                    'field_type' => 'choice'
                ))
    ...
    public function getFullTextFilter($queryBuilder, $alias, $field, $value)
    {
        ...
        $queryBuilder->andWhere($queryBuilder->expr()->orX(
            $queryBuilder->expr()->like($alias.'.nome', $queryBuilder->expr()->literal('%' . $value['value'] . '%'))
   ...
   public function prePersist($object) {
    ...
    public function preUpdate($object) {
		...
		if ($aprovado=='SIM' && $situacao=='ENTRADA' ){
				...
				//$data = $object->getDataOcorrencia();
				
				//$explode_data = explode(" ",$data->dataOcorrencia);
				...
				if($tipoReporte == 'CIVIL' && $coluna_numero == 0) {
				...
				} elseif ($tipoReporte == 'MILITAR' && $coluna_numero_militar == 0){
				...
				//return $this->redirect($this->generateUrl('page-aguardando/list'));
