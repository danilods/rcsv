...
class AguardandoMilitarAdmin extends AbstractAdmin{
    //put your code here
    
    
      
     protected $baseRouteName = 'rcsv_aguardando_resposta_militar';
    protected $baseRoutePattern = 'page-aguardando-militar';
