...
class AguardandoNovaMilitarAdmin extends AbstractAdmin{
    //put your code here
    
    
      
     protected $baseRouteName = 'rcsv_aguardando_nova_resposta_militar';
     protected $baseRoutePattern = 'page-aguardando-nova-militar';
      ...
      public function createQuery($context = 'list')
{
    ...
    $query->andWhere(
        $query->expr()->eq($query->getRootAliases()[0]. '.tipoReporte', ':my_param2')

    );
	
    $query->setParameter('my_param', 'AGUARDANDO SEGUNDA RESPOSTA');
	$query->setParameter('my_param2', 'MILITAR');
