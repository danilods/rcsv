...
class AguardandoNovaCivilAdmin extends AbstractAdmin{
    //put your code here
    
    
      
     protected $baseRouteName = 'rcsv_aguardando_nova_resposta_civil';
     protected $baseRoutePattern = 'page-aguardando-nova-resposta-civil';
