...
/**
 * Description of FeedbackRelatorAdmin
 *
 * @author cenipa
 */
...
class DenunciaAdmin extends AbstractAdmin{
    //put your code here
    
    
    
        
     protected $baseRouteName = 'rcsv_denuncia';
    protected $baseRoutePattern = 'page-denuncia';
	protected $objReg;
      ...
      public function createQuery($context = 'list')
{
    ...
    $query->setParameter('my_param', 'DENUNCIA');
    return $query;
}
