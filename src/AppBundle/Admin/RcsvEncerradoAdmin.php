...
/**
 * Description of RcsvEncerradoAdmin
 *
 * @author cenipa
 */
...
class RcsvEncerradoAdmin extends AbstractAdmin{
    //put your code here
    
  
    protected $baseRouteName = 'rcsv_encerrado_ocorrencia';
    protected $baseRoutePattern = 'page-encerrado';
      ...
      public function createQuery($context = 'list')
{
    ...
    $query->setParameter('my_param', 'ENCERRADO');
    return $query;
}
							 ...
							 ->add('classificacao', 'entity', array('class' => 'AppBundle\Entity\RcsvTaxonomiaClassificacao',
								...
								->add('situacaoRcsv', 'choice', array(
                                    'choices' => array(
										...
										'AGUARDANDO NOVA RESPOSTA' => 'AGUARDANDO NOVA RESPOSTA',
